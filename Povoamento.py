...
df = pd.read_csv('C:/UFBa/Projeto/rs_dados_cienciaetecnologia_energia/data/POVOAMENTO.csv', sep = ';')
...
for i in range(0,len(df)):
    ...
    code = list(pd.read_csv('C:/UFBa/Projeto/rs_dados_cienciaetecnologia_energia/data/'+codigol1[i],sep=';', encoding= 'latin-1'))
